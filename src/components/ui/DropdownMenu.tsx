...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-purple-50 data-[state=open]:bg-purple-50',
      inset && 'pl-8',
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl border border-gray-200 bg-white/95 backdrop-blur-md p-1 shadow-lg',
